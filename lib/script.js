...
let photoItems = document.querySelectorAll('.section-photogallery__photo-toggle-item');
let biggerPhoto = document.querySelector('.bigger__photo');
...
biggerPhoto.addEventListener('click', () => {
...
for (let photo of photoItems) {
  photo.addEventListener('click', () => {
    let wrapper = document.querySelector('.bigger__photo');
